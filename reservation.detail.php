    ...
    <div class="container pt-2 mt-5">
        <div class="p-3 border border-3 border-dark bg-primary d-flex mt-2">
          <div class="col-6 m-auto" style="align-items: center !important;">
                ...
                $film = Film::readByCatId($filmId);
                var_dump($film);
                //Catégorie du film
                $category_id = (int)$film['category_id'];
                ...
                ?>
                <div class="col">
                  <h3>Client : <?php echo $customerId["last_name"] ?> <?php echo  $customerId["first_name"] ?> </h3>              
                  <p>Date de la location : <strong><?php echo $rental["rental_date"] ?></strong></p> 
                  <p>Enregistré par : <strong><?php echo $Staff['first_name'] ?></strong></p>                
                  <p>Date retour de la location : <strong><?php echo $rental["return_date"] ?></strong></p>     
                </div>         
          </div>
